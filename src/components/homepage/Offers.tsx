      ...
      <section className="py-20 md:py-28 bg-ivory">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {offers.map((offer) => (
              ...
              >
                ...
                <div className="flex-1 p-8 flex flex-col items-center text-center bg-white">
                  ...
                  <button className="mt-auto px-10 py-4 bg-[#1a2332] text-white text-sm font-medium uppercase tracking-wider">
                    {offer.action}
                  </button>
                </div>
              </a>
          ...
          <div className="mt-14 text-center">
            <a
              href="/offers"
              className="inline-flex items-center gap-4 px-8 py-4 border border-alpha/20 text-xs font-primary uppercase tracking-[0.15em] text-alpha"
            >
              View All Offers
